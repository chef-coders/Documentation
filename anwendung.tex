...
\dfigure{figures/login.png}{figures/shop.png}{Login-Ansicht und Shop-Ansicht}{\label{loginshopscreen}}
...
\cfigure{figures/barcodeScanner-createItem.png}{Barcode Scanner - Einfach neue Artikel anlegen}{\label{barcodeScanner-createItem}}
...
\cfigure{figures/history.png}{Liste getätigter Einkäufe}{\label{purchases-screen}}
...
\dfigure{figures/edit-user.png}{figures/users.png}{Nutzer-Bearbeiten-Ansicht und Nutzer-Ansicht}{\label{userScreen}}
...
\dfigure{figures/statistics-all.png}{figures/statistics-mine.png}{Statistiken - Ansicht des Administrators und Ansicht des Benutzers}{\label{statistics-admin}\label{statistics-user}}
