...
Wird auf den Anlegen-Button getippt so wird der Artikel erstellt. Es öffnet sich wieder der Shop-Screen im Bearbeitungs-Modus, dessen Artikel-Liste den neu erstellten Artikel enthält.
