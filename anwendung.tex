...
Es wird ein neuer Nutzer auf Basis der in der Oberfläche eingegebenen Anmeldedaten (Name, E-Mail, Admin-Flag, siehe Abbildung~\ref{loginscreen}) erstellt.
...
Im Nutzer-bearbeiten-Screen kann der Benutzer sein eigenes Profil bearbeiten (siehe Abbildung~\ref{editUserScreen}).

\cfigure{figures/screen_placeholder.png}{Nutzer-bearbeiten-Screen}{\label{editUserScreen}}
...
Dieser zeigt eine Liste der Gegenstände, die zum Kaufen verfügbar sind (siehe Abbildung ~\ref{shopscreen}).

% Bild vom Main-Screen mit Item-Liste, evtl. Erklärungen anpassen
\cfigure{figures/screen_placeholder.png}{Shop-Screen}{\label{shopscreen}}
...
Beim Klick auf \gqq{yes} wird der Kauf getätigt und man wird auf den Shop-Screen weitergeleitet.
...
% TODO - Beschreibung der Shortcut-Funktion der App im Android-Homescreen
