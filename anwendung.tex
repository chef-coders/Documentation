...
Darunter zeigen sich viele Buttons, mit denen zu den verschiedenen Screens des Haupt-Screens navigiert werden kann:
...
\subsection{Shop-Screen (Zusätzliche Admin Funktionalitäten)} \label{subsec:shop-screen-admin}
