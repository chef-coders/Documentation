...
\dfigure{figures/screen_placeholder.png}{figures/screen_placeholder.png}{Login-Ansicht und Shop-Ansicht}{\label{loginshopscreen}}
...
Durch das Klicken auf diesen kann man den Einkaufswagen in einer separaten Ansicht betrachten und den Kauf tätigen.
...
Wenn alle gewünschten Gegenstände ausgewählt sind, wird durch einen Klick auf den Einkaufswagen-Button die Warenkorb-Ansicht geöffnet.
...
Beim Klick auf \gqq{yes} wird der Kauf getätigt und man wird auf die Shop-Ansicht weitergeleitet.
...
Durch einen Klick auf das Kamera-Icon in der oberen rechten Ecke der Shop-Ansicht, das in Abbildung~\ref{mainscreen} zu sehen ist, öffnet sich die Kamera des Gerätes mit einem eingebauten Barcode-Scanner, wie in Abbildung~\ref{barcodeScanner}.
Hiermit kann der Benutzer Barcodes einscannen und die Artikel bequemer erwerben.

\dfigure{figures/barcodeScanner.png}{figures/barcodeScanner-purchaseItem}{Barcode Scanner}{\label{barcodeScanner}}
...
\dfigure{figures/button-createItem.png}{figures/button-editItem.png}{Anlegen eines neuen Artikels / Bestehenden Artikel bearbeiten}{\label{createEditItem}}
...
\cfigure{figures/barcodeScanner-createItem}{Barcode Scanner - Einfach neue Artikel anlegen}{\label{barcodeScanner-createItem}}
...
\dfigure{figures/screen_placeholder.png}{figures/screen_placeholder.png}{Nutzer-Bearbeiten-Ansicht und Nutzer-Ansicht}{\label{userScreen}}
...
\dfigure{figures/statistics-admin-all.png}{figures/statistics-user.png}{Statistiken - Ansicht des Administrators und Ansicht des Benutzers}{\label{statistics-admin}\label{statistics-user}}
