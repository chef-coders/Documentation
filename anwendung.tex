...
\cfigure{figures/button-editItem.png}{Bestehenden Artikel bearbeiten}{\label{editItem}}
...
\cfigure{figures/button-createItem.png}{Anlegen eines neuen Artikels}{\label{createItem}}
...
Tippt der Benutzer auf einen List-Eintrag, öffnet sich der Nutzer-bearbeiten-Screen, der in Abschnitt~\ref{subsec:edit-user-screen} besprochen wurde.
Statt des eigenen Benutzer-Accounts, kann stattdessen der Account des ausgewählten Benutzers bearbeitet werden.
...
\dfigure{figures/statistics-admin.png}{figures/statistics-user.png}{Statistiken - Ansicht des Administrators und Ansicht des Benutzers}{\label{statistics-admin}\label{statistics-user}}
...
\subsection{Shortcut-Funktion zum Scannen von Artikeln}
