...
Dafür wurde die moderne Listen-Klasse RecyclerView verwendet.
Um Redundanz zu vermeiden, wurde die, in Abbildung~\ref{fig:recyclerview-diagram} am Beispiel des AllUser-Fragments gezeigte, Architektur implementiert.

\cfigureLarge{figures/general-recyclerview-diagram.png}{RecyclerView Architektur im Fall des AllUser-Fragments}{\label{fig:recyclerview-diagram}}
